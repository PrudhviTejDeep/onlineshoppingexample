<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Samsung.aspx.cs" Inherits="shoppingcart.Samsung" %>
        ...
        <table style="width: 561px" cellspacing="0"
            ...
            <tr>
                <td style="width: 400px; height: 300px">
                    ...
                    <asp:Image id="img" runat="server" Width="150px" Height="250px" ImageUrl="~/Images/samsung-galaxy-j5-2016-sm-j510fzwuins-original-imaeg8cyzupzrkcc.jpeg"/>
                </td>
                <td style="height: 300px;width:250px" >
                   

                    <asp:Label  ID="lbl" runat="server" text="Samsung Galaxy J5" ForeColor="Blue"></asp:Label>
                    <br /><br />
                    <asp:Label  ID="Label6" runat="server" text="Rs 12,499" ForeColor="Blue"></asp:Label>
                     <br /><br />
                    ...
                    <asp:BulletedList ID="blst" runat="server" ForeColor="Blue" >
                        ...
                        <asp:ListItem>5.2 inch Full Hd Display</asp:ListItem>
                        <asp:ListItem>8Mp Primary Camera</asp:ListItem>
