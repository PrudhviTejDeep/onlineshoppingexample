<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nike.aspx.cs" Inherits="shoppingcart.Nike" %>
        ...
        <table style="width: 561px" cellspacing="0"
            ...
            <tr>
                ...
                <td style="height: 300px;width:250px" >
                    ...
                    <asp:Label  ID="lbl" runat="server" text="Nike Revolution 2M" ForeColor="Blue"></asp:Label>
                    <br /><br />
                    <asp:Label  ID="Label6" runat="server" text="Rs 2,499" ForeColor="Blue"></asp:Label>
                     <br /><br />
                    ...
                    <asp:BulletedList ID="blst" runat="server" ForeColor="Blue" >
                        <asp:ListItem >Color:Black,grey,white</asp:ListItem>
