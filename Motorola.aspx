<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Motorola.aspx.cs" Inherits="shoppingcart.Motorola" %>
        ...
        <table style="width: 561px" cellspacing="0"
            ...
            <tr>
                <td style="width: 400px; height: 300px">
                    ...
                    <asp:Image id="img" runat="server" Width="150px" Height="250px" ImageUrl="~/Images/motorola-moto-x-play-with-turbo-charger-xt1562-original-imaefrd46nmdtgza.jpeg"/>
                </td>
                <td style="height: 300px;width:250px" >
                   

                    <asp:Label  ID="lbl" runat="server" text="Motorola X Play" ForeColor="Blue"></asp:Label>
                    <br /><br />
                    <asp:Label  ID="Label6" runat="server" text="Rs 15,499" ForeColor="Blue"></asp:Label>
                     <br /><br />
                    ...
                    <asp:BulletedList ID="blst" runat="server" ForeColor="Blue" >
                        ...
                        <asp:ListItem>5.5inch Full Hd Display</asp:ListItem>
                        <asp:ListItem>13Mp Primary Camera</asp:ListItem>
                        <asp:ListItem>3750 Mah Battery</asp:ListItem>
